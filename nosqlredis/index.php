...
if (!isset($_SESSION['gameStarted'])) {
    ...
    var_dump($redis->sMembers('points:1'));

    $_SESSION['gameStarted'] = true;

    $wordToDisplayInPlace = "";
}
...
if (isset($_POST['LETTER'])) {
    ...
    if ($redis->TTL('WordToFind') > 0) {
        ...
        if (letterAlreadyIn($letterValue, $redis) == false) {
            ...
            //Si le nombre d'essais est à zéro : c'est fini
            ...
            //On change le joueur qui propose la lettre
...
function showWordToDisplay($wordToDisplay)
{
    for ($i = 0; $i < strlen($wordToDisplay); $i++) {
        $wordToDisplayInPlace  = $wordToDisplay[$i] . " ";
    }
}
?>
...
<body>
    ...
    <nav class="navbar navbar-light bg-light">
        ...
        <span class="navbar-text">
            Bonjour <?php echo ("Joueur " . $_SESSION['IsProposingLetter']) ?>, ton score est 10293 points !
        </span>
    </nav>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <span><?php echo ($_SESSION['nbTries']); ?> essais</span>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
